...
@Component({
    ...
    styles: [],
    templateUrl: './member-area-add-payment.component.html'
})
export class MemberAreaAddPaymentComponent implements OnInit, OnDestroy  {
    ...
    constructor(@Inject(MAT_DIALOG_DATA) row: any,
                ...
                private dialogRef: MatDialogRef<MemberAreaAddPaymentComponent>) {
