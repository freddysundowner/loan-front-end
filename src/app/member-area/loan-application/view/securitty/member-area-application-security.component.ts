...
import { MemberAreaAddApplicationSecurityComponent } from './add/member-area-add-application-security.component';
import { MemberAreaEditApplicationSecurityComponent } from './edit/member-area-edit-application-security.component';
...
@Component({
    ...
    templateUrl: './member-area-application-security.component.html',
    styleUrls: ['./member-area-application-security.component.css']
})
export class MemberAreaApplicationSecurityComponent implements OnInit, AfterViewInit {
    collateralColumns = [
        'title',
        'valuation_date',
        'valuation_amount',
    ...
    addDialog(id) {
        ...
        const dialogRef = this.dialog.open(MemberAreaAddApplicationSecurityComponent, dialogConfig);
    ...
    editDialog(collateral: CollateralModel) {
        ...
        const dialogRef = this.dialog.open(MemberAreaEditApplicationSecurityComponent, dialogConfig);
        dialogRef.afterClosed().subscribe(
            (val) => {
                if ((val)) {
                    this.loadData();
