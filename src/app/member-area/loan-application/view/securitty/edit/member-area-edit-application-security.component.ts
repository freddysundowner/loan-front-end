...
@Component({
    ...
    styles: [],
    templateUrl: './member-area-edit-application-security.component.html'
})
export class MemberAreaEditApplicationSecurityComponent implements OnInit  {
    ...
    private dialogRef: MatDialogRef<MemberAreaEditApplicationSecurityComponent>) {
