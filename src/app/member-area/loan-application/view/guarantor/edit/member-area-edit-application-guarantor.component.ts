...
@Component({
    ...
    styles: [],
    templateUrl: './member-area-edit-application-guarantor.component.html'
})
export class MemberAreaEditApplicationGuarantorComponent implements OnInit  {
    ...
    constructor(@Inject(MAT_DIALOG_DATA) row: any,
                ...
                private methodService: MemberAreaApplicationGuarantorService,
                private notification: NotificationService,
    private dialogRef: MatDialogRef<MemberAreaEditApplicationGuarantorComponent>) {
