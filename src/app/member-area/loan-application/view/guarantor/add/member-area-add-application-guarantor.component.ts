...
@Component({
    ...
    styles: [],
    templateUrl: './member-area-add-application-guarantor.component.html'
})
export class MemberAreaAddApplicationGuarantorComponent implements OnInit  {
    ...
    constructor(@Inject(MAT_DIALOG_DATA) row: any,
                ...
                private dialogRef: MatDialogRef<MemberAreaAddApplicationGuarantorComponent>) {
