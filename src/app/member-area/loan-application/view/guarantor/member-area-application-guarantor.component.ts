...
import { MemberAreaApplicationGuarantorDataSource } from './data/member-area-application-guarantor-data.source';
import { MemberAreaApplicationGuarantorService } from './data/member-area-application-guarantor.service';
import { MemberAreaAddApplicationGuarantorComponent } from './add/member-area-add-application-guarantor.component';
import { ApplicationGuarantorModel } from './model/application-guarantor.model';
import { MemberAreaEditApplicationGuarantorComponent } from './edit/member-area-edit-application-guarantor.component';
...
@Component({
    ...
    templateUrl: './member-area-application-guarantor.component.html',
    styleUrls: ['./member-area-application-guarantor.component.css']
})
export class MemberAreaApplicationGuarantorComponent implements OnInit, AfterViewInit {
    displayedColumns = [
        'member_id',
        'created_by',
        'created_at',
    ...
    dataSource: MemberAreaApplicationGuarantorDataSource;
    ...
    constructor(private service: MemberAreaApplicationGuarantorService, private notification: NotificationService,
                private dialog: MatDialog, private loanApplicationService: MemberAreaLoanApplicationService,
    ...
    ngOnInit() {
        ...
        this.dataSource = new MemberAreaApplicationGuarantorDataSource(this.service);
    ...
    addDialog() {
        ...
        const dialogRef = this.dialog.open(MemberAreaAddApplicationGuarantorComponent, dialogConfig);
    ...
    editDialog(guarantor: ApplicationGuarantorModel) {
        ...
        const dialogRef = this.dialog.open(MemberAreaEditApplicationGuarantorComponent, dialogConfig);
        dialogRef.afterClosed().subscribe(
            (val) => {
                if ((val)) {
                    this.loadData();
