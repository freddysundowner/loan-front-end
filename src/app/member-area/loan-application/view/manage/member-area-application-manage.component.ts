...
@Component({
    ...
    templateUrl: './member-area-application-manage.component.html',
    styleUrls: ['./member-area-application-manage.component.css']
})
export class MemberAreaApplicationManageComponent implements OnInit, OnDestroy {
    form: FormGroup;
    chargeFields: FormArray;

    formErrors: any;

    method: MemberAreaApplicationManageModel;
