...
@Component({
    ...
    styles: [],
    templateUrl: './member-area-edit-loan-application.component.html'
})
export class MemberAreaEditLoanApplicationComponent implements OnInit, AfterViewInit, OnDestroy  {
    ...
    constructor(@Inject(MAT_DIALOG_DATA) row: any,
                ...
                private memberAreaLoanApplicationService: MemberAreaLoanApplicationService,
                ...
                private dialogRef: MatDialogRef<MemberAreaEditLoanApplicationComponent>) {
        this.loanApplication = row.loanApplication;
        this.memberId = row.userId;
      ...
      //  this.userPhone = this.users.find((item: any) => item.id === this.loanApplication.loan_officer_id).phone;
        ...
        this.firstFormGroup = this.fb.group({
          /*  member_id: [this.loanApplication.member_id, [Validators.required,
            ...
            repayment_period: [{value: this.repaymentPeriod, disabled: false}],
    ...
    private updateApplicationForm(formData: FormData) {
        // Upload photo
        this.memberAreaLoanApplicationService.updateApplicationForm(formData)
            .subscribe((data) => {
                    this.loader = false;
    ...
    update() {
        ...
        this.memberAreaLoanApplicationService.update(body)
            .subscribe((res) => {
