...
@Component({
    ...
    styles: [],
    templateUrl: './member-area-add-loan-application.component.html'
})
export class MemberAreaAddLoanApplicationComponent implements OnInit, OnDestroy  {
    ...
    constructor(@Inject(MAT_DIALOG_DATA) row: any,
        private fb: FormBuilder, private router: Router, private memberService: MemberService,
                ...
                private notification: NotificationService, private memberAreaLoanApplicationService: MemberAreaLoanApplicationService,
                private memberMethodService: PaymentMethodSettingService, private dialogRef: MatDialogRef<MemberAreaAddLoanApplicationComponent>) {
    ...
    create() {
       ...
       // body.repayment_period = this.repaymentPeriod;
        ...
        this.loader = true;
        this.memberAreaLoanApplicationService.create(formData)
            .subscribe((res) => {
                    this.onSaveComplete();
