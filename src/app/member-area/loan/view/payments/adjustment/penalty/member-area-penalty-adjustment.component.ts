...
@Component({
    ...
    styles: [],
    templateUrl: './member-area-penalty-adjustment.component.html'
})
export class MemberAreaPenaltyAdjustmentComponent implements OnInit, AfterViewInit  {
    ...
    constructor(@Inject(MAT_DIALOG_DATA) row: any,
                ...
                private dialogRef: MatDialogRef<MemberAreaPenaltyAdjustmentComponent>) {
