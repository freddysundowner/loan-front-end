...
@Component({
    ...
    styles: [],
    templateUrl: './member-area-principal-transaction.component.html'
})
export class MemberAreaPrincipalTransactionComponent implements OnInit, AfterViewInit  {
    ...
    constructor(@Inject(MAT_DIALOG_DATA) row: any,
                ...
                private dialogRef: MatDialogRef<MemberAreaPrincipalTransactionComponent>) {
