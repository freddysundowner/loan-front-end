...
@Component({
    ...
    styles: [],
    templateUrl: './member-area-interest-transaction.component.html'
})
export class MemberAreaInterestTransactionComponent implements OnInit, AfterViewInit  {
    ...
    constructor(@Inject(MAT_DIALOG_DATA) row: any,
                ...
                private dialogRef: MatDialogRef<MemberAreaInterestTransactionComponent>) {
