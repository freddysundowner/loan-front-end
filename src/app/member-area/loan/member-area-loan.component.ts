...
import { AddLoanComponent } from '../../loans/add/add-loan.component';
import { LoanModel } from '../../loans/models/loan-model';
import { LoanAmortizationComponent } from '../../loans/amortization/loan-amortization.component';
import { EditLoanComponent } from '../../loans/edit/edit-loan.component';
...
import { MemberAreaLoanDataSource } from './data/member-area-loan-data.source';
import { MemberAreaLoanAmortizationComponent } from './amortization/member-area-loan-amortization.component';


@Component({
    selector: 'app-member-are-loans',
    templateUrl: './member-area-loan.component.html',
    styleUrls: ['./member-area-loan.component.css']
})
export class MemberAreaLoanComponent implements OnInit, AfterViewInit {
    displayedColumns = [
        'loan_officer',
    ...
    constructor(private service: MemberAreaLoanService, private notification: NotificationService,
    ...
    ngOnInit() {
        ...
        this.dataSource = new MemberAreaLoanDataSource(this.service);

        // Load pagination data
        this.dataSource.meta$.subscribe((res) => this.meta = res);

        // We load initial data here to avoid affecting life cycle hooks if we load all data on after view init
        this.dataSource.load('', 0, 0, 'updated_at', 'desc', 'closed_on');
    }
    ...
    amortizationDialog(loan: LoanModel) {
        ...
        const dialogRef = this.dialog.open(MemberAreaLoanAmortizationComponent, dialogConfig);
    }
