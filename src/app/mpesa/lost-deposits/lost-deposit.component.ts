...
import { AddPaymentComponent } from '../../payments/general/add/add-payment.component';
...
@Component({
    ...
    templateUrl: './lost-deposit.component.html',
    styleUrls: ['./lost-deposit.component.css']
})
export class LostDepositComponent implements  OnInit, AfterViewInit {
