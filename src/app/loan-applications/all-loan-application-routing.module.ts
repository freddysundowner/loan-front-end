...
import { LoanApplicationComponent } from './all-loan-application.component';
    ...
    { path: 'create', component: AddLoanApplicationComponent },
    {
        ...
        children: [
            ...
            { path: 'collateral', component: ApplicationSecurityComponent },
            {
                ...
                loadChildren: () => import('app/loan-applications/view/manage/application-manage.module').then(m => m.ApplicationManageModule),
                canLoad: [PermGuard],
                data: {
